        ...
        private void createRandomExamToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (questionList != null)
                {
                    ...
                    {
                        MessageBox.Show("Make exam success vs ExamID is " + examID, "Notice", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                    else
                    {
                        MessageBox.Show("Make exam fail", "Notice", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    }
                }
            }
            catch
